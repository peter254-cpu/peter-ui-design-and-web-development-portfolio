                ...
                <div className='grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-0 h-fit'>
                    <div className='col-span-1 xl:row-span-3'>
                        <div className='grid-container'>
                            <img src='/assets/grid1.png' className='w-full sm:h-[276px] h-fit object-contain opacity-80' />
                            <div>
                    ...
                    <div className='xl:col-span-2 xl:row-span-3'>
                        <div className='grid-container'>
                            <img src='/assets/grid3.jpg' alt='grid2 img' className='min-w-full sm:h-[266px] h-fit object-contain border-black-100 rounded-xlg' />
                            <div>
